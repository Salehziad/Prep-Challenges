...
const oddFiltration = (arr) => {
    ...
    const result=arr.filter(element=> element%2 != 0 && element%2!=0)
    return result;
}
// -------------------------------------------------------------------------------------------------------
...
const vowelsFiltration = (arr) => {
    // write your code here
    const result=arr.filter(element=>element=vowels.test(element))
    return result
} 
// -------------------------------------------------------------------------------------------------------
...
const skillComparison = (arr1, arr2) => {
    // write your code here
    var result1 = arr2.filter(element => !arr1.includes(element)&& arr1.includes(element));
    return result1;
}
// -------------------------------------------------------------------------------------------------------
